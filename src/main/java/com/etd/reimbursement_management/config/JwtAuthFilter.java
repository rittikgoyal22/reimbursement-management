...
import com.etd.reimbursement_management.client.AuthServiceClient;
import com.etd.reimbursement_management.util.JWTUtil;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            try {
                ...
                // Fail-open: if auth-service is unreachable, skip blacklist check
                // and proceed with signature + expiry validation only
